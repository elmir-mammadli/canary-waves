...
export interface ApiAboutSectionAboutSection extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    pillars: Schema.Attribute.Component<'shared.text-item', true>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiHeroSectionHeroSection extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    notes: Schema.Attribute.Component<'shared.text-item', true>;
...
export interface ApiImpactSectionImpactSection extends Struct.SingleTypeSchema {
  collectionName: 'impact_sections';
  info: {
...
export interface ApiSignalsSectionSignalsSection
  extends Struct.SingleTypeSchema {
  collectionName: 'signals_sections';
  info: {
    displayName: 'Signals Section';
    pluralName: 'signals-sections';
    singularName: 'signals-section';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::signals-section.signals-section'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.Text & Schema.Attribute.Required;
...
export interface ApiWorkflowSectionWorkflowSection
  extends Struct.SingleTypeSchema {
  collectionName: 'workflow_sections';
  info: {
    displayName: 'Workflow Section';
    pluralName: 'workflow-sections';
    singularName: 'workflow-section';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::workflow-section.workflow-section'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    steps: Schema.Attribute.Component<'shared.workflow-step', true>;
    title: Schema.Attribute.Text & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::signals-section.signals-section': ApiSignalsSectionSignalsSection;
      'api::team-section.team-section': ApiTeamSectionTeamSection;
      'api::why-us-section.why-us-section': ApiWhyUsSectionWhyUsSection;
      'api::workflow-section.workflow-section': ApiWorkflowSectionWorkflowSection;
